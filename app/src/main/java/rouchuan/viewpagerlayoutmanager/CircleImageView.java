...
public class CircleImageView extends AppCompatImageView {
    ...
    private static final int SQUARE_SIZE_BY_WIDTH = 0;
    private static final int SQUARE_SIZE_BY_HEIGHT = 1;
    private static final int SQUARE_SIZE_BY_MINIMUM = 2;
    private static final int SQUARE_SIZE_BY_MAXIMUM = 3;
    private static final int SQUARE_SIZE_DEFAULT = 4;

    private int squareSizeBy;
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        squareSizeBy = a.getInt(R.styleable.CircleImageView_civ_squareSizeBy, SQUARE_SIZE_DEFAULT);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (squareSizeBy == SQUARE_SIZE_BY_WIDTH) {
            setMeasuredDimension(getMeasuredWidth(), getMeasuredWidth());
        } else if (squareSizeBy == SQUARE_SIZE_BY_HEIGHT) {
            setMeasuredDimension(getMeasuredHeight(), getMeasuredHeight());
        } else if (squareSizeBy == SQUARE_SIZE_BY_MINIMUM) {
            int sideLength = Math.min(getMeasuredWidth(), getMeasuredHeight());
            setMeasuredDimension(sideLength, sideLength);
        } else if (squareSizeBy == SQUARE_SIZE_BY_MAXIMUM) {
            int sideLength = Math.max(getMeasuredWidth(), getMeasuredHeight());
            setMeasuredDimension(sideLength, sideLength);
        }
    }
